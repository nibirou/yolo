...
hello，这里是dejahu，从这周开始，我们将会每周更新一期优质开源项目分享，主要是python和人工智能方面的项目

本期给大家打开的是YOLOv5在智能工地安全领域中头盔目标检测的应用。

<font color='red'>**如果大家对视频教程感兴趣的话，请在博客下方点赞留言，点赞超过100我们更新配置视频教程，手把手教你跑项目**</font>

该项目是使用 `YOLOv5 v2.x` 的程序来训练在智能工地安全领域中头盔目标检测的应用

> 数据集下载地址：[Dejahu-Safety-Helmet-Wearing-Dataset: 安全帽检测数据集 (gitee.com)](https://gitee.com/song-laogou/dejahu-safety-helmet-wearing-dataset)
>
> 代码下载地址：[宋老狗/dejahu-smart-helmet (gitee.com)](https://gitee.com/song-laogou/dejahu-smart-helmet)

## 可视化界面演示：
:boom::boom::boom:新增可视化界面上线啦！！！！来一波演示！！！


![](https://vehicle4cm.oss-cn-beijing.aliyuncs.com/typoraimgs/visualize_tool_gif_v2_1.gif)

## 演示

![](https://vehicle4cm.oss-cn-beijing.aliyuncs.com/typoraimgs/output_1.jpg)
![](https://vehicle4cm.oss-cn-beijing.aliyuncs.com/typoraimgs/output_2.jpg)
![](https://vehicle4cm.oss-cn-beijing.aliyuncs.com/typoraimgs/output_3.jpg)
![](https://vehicle4cm.oss-cn-beijing.aliyuncs.com/typoraimgs/output_4.jpg)
...
![](https://vehicle4cm.oss-cn-beijing.aliyuncs.com/typoraimgs/test_batch0_gt.jpg)
...
![](https://vehicle4cm.oss-cn-beijing.aliyuncs.com/typoraimgs/area_output_1.jpg)
![](https://vehicle4cm.oss-cn-beijing.aliyuncs.com/typoraimgs/area_output_2.jpg)
